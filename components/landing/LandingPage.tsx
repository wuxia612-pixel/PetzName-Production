...
export function LandingPage() {
  ...
  return <>
    ...
    </main><footer><Container className="footer-row"><a href="https://petzname.com" aria-label="PetzName home">petzname.com</a><span>Thoughtful names for every kind of companion.</span></Container></footer>
  </>;
}
