...
export function LandingPage() {
  ...
  return <>
    ...
    <header className="topnav"><Container className="nav-inner"><a className="brand" href="#top"><span className="brand-mark" />Pet Name Generator</a><nav aria-label="Primary navigation"><a href="#generator">Generate names</a><a href="#how">How it works</a><a href="#faq">FAQ</a><a className="nav-info-link" href="/about">About</a><a className="nav-info-link" href="/contact">Contact</a><a className="nav-info-link" href="/privacy">Privacy</a><a className="nav-info-link" href="/terms">Terms</a></nav></Container></header>
    <main id="top">
