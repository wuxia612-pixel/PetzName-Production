...
const data = { "@context": "https://schema.org", "@graph": [
  ...
  { "@type": "WebApplication", "@id": `${site.url}/#app`, name: "Pet Name Generator", url: site.url, applicationCategory: "LifestyleApplication", operatingSystem: "Any", isAccessibleForFree: true, description: site.description, publisher: { "@id": `${site.url}/#organization` } },
